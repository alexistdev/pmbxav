...
<!DOCTYPE html>
<html>
<?php $this->load->view('siswa/template/v_header') ?>

<body class="hold-transition sidebar-mini pace-danger">
<div class="wrapper">
	<!-- Site wrapper -->
	<?php $this->load->view('siswa/template/v_navbar') ?>
	<?php $this->load->view('siswa/template/v_sidebar') ?>
	<?php $this->load->view('siswa/konten/k_member') ?>
	<?php $this->load->view('siswa/template/v_footer') ?>
</div>
